...
This book was created using `r R.version.string` (`r R.version$nickname`) and RStudio version 2022.12.0.353 (Elsbeth Geranium). Most of the content of this book will work fine in versions of R above 4.0 and earlier versions of RStudio, although there may be some small differences in the interface.
:::
...
```{r fig-rstudio, echo=FALSE, fig.cap="The RStudio IDE"}

...
<a href="https://psyteachr.github.io/ads-v2/data/survey_data.csv" download>survey_data.csv</a> and <a href="https://psyteachr.github.io/ads-v2/data/scottish_population.csv" download>scottish_population.csv</a>.
...
The code below creates two familiar plots from @sec-viz), using the default (light) theme and palettes. First, load the data and set `issue_category` to a factor so you can control the order of the categories.
...
```{r histogram-example, fig.cap="Histogram of wait times."}
...
```{r freqpoly-example, fig.cap="Frequency plot of wait times."}
ggplot(survey_data, aes(x = wait_time)) +
...
```{r density-example, fig.cap="Density plot of wait times."}
ggplot(survey_data, aes(x = wait_time)) +
  scale_x_continuous(name = "Wait time (seconds)",
                     breaks = seq(0, 600, 60)) +
...
You can join <a href="https://psyteachr.github.io/ads-v2/data/scottish_population.csv" download>Scottish population data</a> to the map table to visualise data on the map using colours or labels.
...
You'll need to make a folder called "data" and download data files into it: 
<a href="https://psyteachr.github.io/ads-v2/data/amazon_alexa.csv" download>amazon_alexa.csv</a> and <a href="https://psyteachr.github.io/ads-v2/data/scottish_population.csv" download>scottish_population.csv</a>.
